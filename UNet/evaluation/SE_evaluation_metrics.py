...
def measure_evaluation_metrics(clean_path, measure_path, metrics):
    evaluation_metrics = {
...
if __name__ == '__main__':
    ...
    # sample_not_considered = ['130_0', '556_4', '655_0', '611_0']
    sample_not_considered = ['655']
    for root, dirs, files in os.walk(root_wav_dir):
        for file in tqdm(files):
            if file.endswith('.wav') and file.startswith('denoised') and file[17:-4] not in sample_not_considered:
                file_id = file[9:-4]
                ...
                results_original = measure_evaluation_metrics(clean_path, noisy_path, considered)
                results_enhanced = measure_evaluation_metrics(clean_path, enhanced_path, considered)
